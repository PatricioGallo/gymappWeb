...
const VIEW_MARKUP = `
  <section class="features">
    <div class="container">
      <span class="eyebrow eyebrow-standalone">Solicitudes de seguimiento</span>
      <p class="chart-sub" id="followReqSummary">Cargando...</p>
      <div class="notif-page-list" id="followReqList"></div>
    </div>
  </section>
`;

export const followRequestsView: ViewModule = {
  async mount(container, _params, _ctx, authUserId) {
    ...
    const summaryEl = container.querySelector("#followReqSummary")!;
    const listEl = container.querySelector("#followReqList")!;
